    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      >
        <div className="text-center space-y-8">
          ...
          >
            <h1 className={`text-6xl font-extrabold text-gray-900 mb-6 tracking-tight ${satoshiClassName}`}>
      ...
      >
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className={`${satoshiClassName} text-xl font-bold mb-3`}>Instant Insights</h3>
          ...
          >
            <div className="text-3xl mb-4">🤖</div>
            <h3 className={`${satoshiClassName} text-xl font-bold mb-3`}>Smart Drafts</h3>
          ...
          >
            <div className="text-3xl mb-4">🔁</div>
            <h3 className={`${satoshiClassName} text-xl font-bold mb-3`}>Auto Follow-Ups</h3>
      ...
      <motion.div 
        ...
        viewport={{ once: true, amount: 0.2 }}
        variants={fadeIn}
        className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white"
      >
        <h2 className={`${satoshiClassName} text-3xl font-bold text-center mb-12`}>How It Works</h2>
        <motion.div 
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        ...
        >
          {[
            ...
            >
              <div className="text-pink-500 text-2xl mb-4">{step.number}</div>
      ...
      >
        <motion.div 
          className="bg-pink-500 rounded-2xl p-12 text-center"
          whileHover={{ scale: 1.01 }}
          transition={{ type: "spring", stiffness: 200 }}
        >
          <h2 className={`${satoshiClassName} text-3xl font-bold text-white mb-4`}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm">© {new Date().getFullYear()} SlideIn. All rights reserved.</p>
